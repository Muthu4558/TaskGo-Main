...
import UpdatePopup from "./components/UpdatePopup.jsx"; // ✅ import popup
...
const App = () => {
  ...
  // ✅ Trigger popup after 10 seconds when logged in
  useEffect(() => {
    if (user) {
  ...
  return (
    <main className="w-full min-h-screen bg-[#f3f4f6]">
      ...
      <UpdatePopup
        ...
        updates={[
          "1. Task Reminders: You can now trigger notifications (via the Bell Icon) to receive WhatsApp & Mail reminders for your tasks. Stay on top of your work with timely reminders!",
          "2. In Project Task Visibility: We've made it easier for you to track tasks within projects. You can now view individual tasks directly on the Task Page, complete with titles and descriptions to keep you informed.",
        ]}
      />
