...
import logo4 from '../assets/images/WebsiteImg/time.png';

const Companies = () => {
    const logos = [logo2, logo1, logo3, logo4];
    ...
    return (
        <div className='py-20 bg-gray-100 text-center'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto px-6 items-center justify-center">
