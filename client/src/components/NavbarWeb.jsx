                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-24">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:space-x-6 space-y-3 md:space-y-0">
                            <button
                                onClick={togglePopup}
                                className="flex items-center gap-2 px-4 py-2 bg-[#229ea6] text-white rounded-lg hover:bg-black transition transform hover:scale-105 w-full md:w-auto justify-center mt-1"
                            >
